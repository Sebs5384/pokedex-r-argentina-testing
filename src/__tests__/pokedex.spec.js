...
test('inicializa pokedex', () => {
  ...
  inicializar().then(() => {
    expect(document.querySelector('#ayuda').textContent).toContain('Seleccioná un pokemon para ver su información');

    expect(document.querySelector('#total-pokemones').textContent).toContain('964');
